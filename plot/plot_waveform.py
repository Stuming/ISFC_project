...
def plot_waveform(wave_data, sessid=None, meanval=None, data_length=None,
    ...
    plt.plot([num for elem in wave_data for num in elem],hold=True)
    ...
    if sessid is not None:
        plt.title("Global waveform " + sessid)
